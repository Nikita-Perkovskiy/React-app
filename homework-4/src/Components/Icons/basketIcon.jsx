...
const Basket = ({ color, number }) => {
  return (
    <div className="basketIcon-wrapper">
      <p className="basketIcon-number">{number}</p>
      <svg
        position="absolute"
        top="0%"
        width="32px"
      ...
      >
        ...
        <defs></defs>
        <g id="Page-1" stroke={color} strokeWidth="2" fill={color}>
          <g id="Basket" fill={color}>
            <path
